...
(function($, window) {
	...
	var Slideshow = function(element, options, callinit) {
		...
		this.$navWrapper = ($(this.options.navWrapper).length) ? $(this.options.navWrapper) : this.$slideshow.parent();
		this.$nav = null;
		this.$bullets   = null;
		this.$controlWrapper = ($(this.options.controlWrapper).length) ? $(this.options.controlWrapper) : this.$slideshow.parent();
